...
void Node::setIsDest(bool isDest)
{
    isDest_ = isDest;
}

void Node::setIsCatTranStop(bool isCatTranStop)
{
    isCatTranStop_ = isCatTranStop;
}
void Node::setIsBikeDepot(bool isBikeDepot)
{
    isBikeDepot_ = isBikeDepot;
}
...
TransportMode Node::mode()
{
    return type_;
}

unsigned int Node::numChildren()
{
    return childCount_;
}
